...
-   Find the mean, median and variance of the search hits for the covid keywords.
...
ggplot(highest_death_frequency, aes(x = reorder(location, -freq), y = freq)) +
  geom_bar(stat = "identity", fill = "darkgreen") +
  labs(x = "City in California (Location)", y = "Search Frequency for Deaths", title = "Which cities have the highest search frequency for deaths related to Covid?") +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
```
